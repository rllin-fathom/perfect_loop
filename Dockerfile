...
RUN pip install imageio numpy scipy matplotlib \
                pandas sympy nose decorator tqdm \
                pillow pytest moviepy pytube
...
RUN pip install fire imageio zappa awscli flask
